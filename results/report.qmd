...
# top 25 for multiple testing
s1 <- tt_corrected %>%
  select(protein, p_by) %>%
  slice_min(order_by = p_by, n = 25) %>%
  pull(protein)
print("Top 25 proteins for multiple testing:")
s1
...
s2 <- rf_out$importance %>% 
  ...
  pull(protein)
print("Top 25 proteins for random forest:")
s2
...
print("Top 25 proteins for correlation testing: ")
s3$protein
```
